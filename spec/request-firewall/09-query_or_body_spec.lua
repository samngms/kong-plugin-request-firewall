...
for _, strategy in helpers.each_strategy() do
  describe(PLUGIN_NAME .. ": (query_or_body) [#" .. strategy .. "]", function()
    local client
        ...
        exact_match = {
          ["/get"] = {
            query_or_body = {
              ...
              x2 = {type = "string", is_array = 1},
              x3 = {type = "string", is_array = 2},
              x4 = {type = "boolean", is_array = 2},
              x5 = {type = "UserTx"}
            },
            custom_classes = {
              UserClass = {
    ...
    describe("testing query_or_body", function()

      it("normal case1", function()
